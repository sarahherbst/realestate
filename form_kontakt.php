<?php
	...
	if ( isset($_POST['submit']) ) {
		...
		if ( !empty($honeypot) ) {
			echo $honeypot; // you may add code here to echo an error etc.
		} else {
			// Variablen einlesen
...
<section class="bg-<?php echo $bg_color; ?> first-section">
	...
	<div class="container py-4">
		...
		<?php } ?>
		<h1 class="display-4 text-light mt-5">Jetzt Termin vereinbaren!</h1>
	...
	<?php if ($form_send !== true) { ?>
		...
		<form action="" method="post">
			...
			<div class="custom-control custom-radio custom-control-inline">
				<input type="radio" class="custom-control-input" name="kd_thema" id="kd_thema1" value="Neubau/Kauf" <?php echo ($kd_thema == 'Neubau/Kauf' ? 'checked' : ''); ?> required>
				<label class="custom-control-label" for="kd_thema1">
					<small>Neubau/Kauf</small>
				</label>
			</div>
			<div class="custom-control custom-radio custom-control-inline">
				<input type="radio" class="custom-control-input" name="kd_thema" id="kd_thema2" value="Modernisieren" <?php echo ($kd_thema == 'Modernisieren' ? 'checked' : ''); ?>>
				<label class="custom-control-label" for="kd_thema2">
					<small>Modernisieren</small>
				</label>
			</div>
			<div class="custom-control custom-radio custom-control-inline">
				<input type="radio" class="custom-control-input" name="kd_thema" id="kd_thema3" value="Anschlussfinanzierung" <?php echo ($kd_thema == 'Anschlussfinanzierung' ? 'checked' : ''); ?>>
				<label class="custom-control-label" for="kd_thema3">
					<small>Anschlussfinanzierung</small>
				</label>
			</div>
			<?php } ?>
