<?php
	...
	if (isset($_POST['submit'])) {
		...
		if (!empty($_FILES['motiv']['tmp_name'])) {
			$upload_folder 			= '../img/berater/large/'; //Das Upload-Verzeichnis
		...
		if ($txt_update == true) {
			$fehlerangabe .= '<div class="alert alert-success" role="alert">Die Angaben zu den Beratern wurden erfolgreich gespeichert.</div>';
			$txt_einleitung 		= str_replace('<br />', '', $txt_einleitung);
			...
			$fehler++;
			$fehlerangabe   .= '<div class="alert alert-danger alert-dismissible fade in" role="alert"><b>Fehler!</b> Die Angaben zu den Beratern konnten nicht gespeichert werden.</div>';
			$txt_einleitung 		= str_replace('<br />', '', $txt_einleitung);
			$txt_conversion_ziel 	= str_replace('<br />', '', $txt_conversion_ziel);
			$txt_einleitung 		= $_POST['txt_einleitung'];
			$txt_conversion_ziel 	= $_POST['txt_conversion_ziel'];
...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Beraterangaben bearbeiten</li>
</ol>

<div class="jumbotron">
	<h1>Beraterangaben bearbeiten</h1>
	<p class="lead">Hier haben Sie die Möglichkeit die Angaben zu den Beratern zu bearbeiten.</p>
</div><!-- /.jumbotron -->
		...
		<div class="col-md-12">
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-home" aria-hidden="true"></i> &nbsp; Beraterangaben
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-12">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<p class="help-block">Geben Sie eine Headline zu den Beratern an.</p>
