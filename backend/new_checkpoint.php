<?php
	...
	if (isset($_POST['submit'])) {
		...
		if ($checkliste_update == true) {
			$alert .= '<div class="alert alert-success" role="alert">Der Checkpoint für die Rubrik <b>'.$row_rubrik['rub_name'].'</b> wurde erfolgreich hinzugefügt.</div>';
			$txt_titel 		= '';
			$txt_einleitung = '';
		} else {
			$fehler++;
			$alert   .= '<div class="alert alert-danger alert-dismissible fade in" role="alert"><b>Fehler!</b> Der Checkpoint für die Rubrik <b>'.$row_rubrik['rub_name'].'</b> konnte nicht hinzugefügt werden.</div>';
...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Checkpoint hinzufügen</li>
</ol>

<div class="jumbotron">
	<h1>Checkpoint hinzufügen</h1>
	<p class="lead">Hier haben Sie die Möglichkeit einen Checkpoint für die Rubrik <b><?php echo $row_rubrik['rub_name']; ?></b> hinzuzufügen.</p>
</div><!-- /.jumbotron -->
