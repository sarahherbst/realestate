...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Bild hinzufügen</li>
</ol>


<div class="jumbotron">
	<h1>Galeriebild hinzufügen</h1>
	<p class="lead">Hier können Sie ein weiteres Bild der Galerie für die Rubrik <b><?php echo $row_rubrik['rub_name']; ?></b> hinzufügen.</p>
</div>
		...
		<div class="col-md-12">
			<div class="card mb-3">
				<div class="card-header">
					<i class="fa fa-image" aria-hidden="true"></i> &nbsp; Bild für die Rubrik <b><?php echo $row_rubrik['rub_name']; ?></b>
				</div>
				<div class="card-body">
					<div class="row">
						<div class="col-md-6">
