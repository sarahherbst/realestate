<?php
	$page 	= 'investitionstool';
	require('header.php');

	$fehlerangabe 	= '';
	$schluessel 	= 'investitionstool';
	...
	if (isset($_POST['submit'])) {
		...
		if ($txt_update == true) {
			$fehlerangabe .= '<div class="alert alert-success" role="alert">Die Angaben zum Investitionstool wurden erfolgreich gespeichert.</div>';
			$txt_einleitung 		= str_replace('<br />', '', $txt_einleitung);
			$txt_einleitung 		= $_POST['txt_einleitung'];
		} else {
			$fehler++;
			$fehlerangabe   .= '<div class="alert alert-danger alert-dismissible fade in" role="alert"><b>Fehler!</b> Die Angaben zum Investitionstool konnten nicht gespeichert werden.</div>';
			$txt_einleitung 		= str_replace('<br />', '', $txt_einleitung);
			$txt_einleitung 		= $_POST['txt_einleitung'];
		}
	}
...
<!-- Breadcrumbs -->
<ol class="breadcrumb">
	<li class="breadcrumb-item active">Investitionstool</li>
	<li class="breadcrumb-item active">Angaben zum Investitionstool bearbeiten</li>
</ol>

<div class="jumbotron">
	<h1>Angaben zum Investitionstool bearbeiten</h1>
	<p class="lead">Hier haben Sie die Möglichkeit die Angaben zum Investitionstool zu bearbeiten.</p>
</div><!-- /.jumbotron -->
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<p class="help-block">Geben Sie eine Headline zum Investitionstool an.</p>
